...
<header>
  ...
  <div class="header-unit">
    ...
    <div><a href="../../Account/cart/" target="-blank" title="Access All Products added to Cart"><img src="../../img/shpp.png"></a></div>
    <div><img src="../../img/heart.png"></div>
    <div><button><a href="../../enter_account/login.php">Login</a></button></div>
  </div>
</header>