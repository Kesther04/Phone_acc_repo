            ...
            <section class='purchase'>
                <h1 class='purch-prod-header'>Apple Watch Series 3 44mm</h1>
                ...
                <div class='snd-purchase-div'>
                    ...
                    <ul>
                        <li>
                            <div>DIMENSIONS</div>
                            <p>44.35 x 26 x 9.99 mm</p>
                        </li>
                        
                        <li>
                            <div>DISPLAY</div>
                            <p>1.47 inch AMOLED<br> 194 x 368 pixels<br> *The AMOLED touchscreen supports slide and touch gestures.</p>
                        </li>
            
                        <li>
                            <div>Watch Strap</div>
                            <p>Graphite Black Silicone Strap,<br>Nebula Pink Silicone Strap,<br>Flame Red Silicone Strap,<br>Wilderness Green Silicone Strap,</p>
                        </li>
            
                        
                        <li>
                            <div>Button</div>
                            <p>Power and function button</p>
                        </li>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>2.4 GHz, BT5.0, BLE</p>
                        </li>
            
                        <li>
                            <div>Charging</div>
                            
                            <p>Charger Voltage and Current Requirements<br>
                            5V 1A/1.5A/2A</p>
                        </li>
            
                        <li>
                            <div>In the box</div>
                            <p>HUAWEI Band 7 x 1<br>
                            Charging cable and cradle x 1</p>
                        </li>
                        ...
                        <li>
                            <div>WEIGHT</div>
                            <p>Approximately 16 g (without the strap)</p>
                        </li>
                        ...
                        <li>
                            ...
                            <p><b>Colour</b><br>dark gray, gold,green, red <br><b>Material</b><br> Durable polymer materials</p>
                        </li>
                    </ul>
                    </div>
                    ...
                    <ul>
                        ...
                        <p>Magnetic charging thimble</p>
                        </li>
            
             
                        <li>
                            <div>Waterproof Level</div>
                            <p>5 ATM water-resistant</p>
                        </li>
            
            
                        <li>
                            <div>Environment</div>
                            <p>Temperature<br> -10 ℃～+45 ℃</p>
                        </li>
            
            
                        <li>
                            <div>Battery Life</div>
                            <p>14 days for typical use</p>
                        </li>
